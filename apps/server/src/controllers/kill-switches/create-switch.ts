...
interface CreateKillSwitchControllerDependencies {
    prisma: typeof prisma;
}

class CreateKillSwitchController {
    private prisma: typeof prisma;

    constructor(dependencies: CreateKillSwitchControllerDependencies) {
...
const createKillSwitchController = new CreateKillSwitchController({
    prisma: dbInstance
});

export const createKillSwitch = createKillSwitchController.createKillSwitch;
